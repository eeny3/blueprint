...
import 'package:one_trade/ui/portfolio_screen/portfolio_all_trade_accounts_view/portfolio_all_trade_accounts_view_wm.dart';
...
/// Cтраница всех счетов торговли пользователя
class PortfolioAllTradeAccountsView
    extends ElementaryWidget<IPortfolioAllTradeAccountsViewWidgetModel> {
  const PortfolioAllTradeAccountsView({
    Key? key,
    WidgetModelFactory wmFactory = defaultAppWidgetModelFactory,
  }) : super(wmFactory, key: key);

  @override
  Widget build(IPortfolioAllTradeAccountsViewWidgetModel wm) {
